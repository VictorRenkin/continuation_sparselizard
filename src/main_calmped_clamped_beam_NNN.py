...
elasticity += sp.integral(PHYSREG_VOLUME, FFT_point, e_fic_mu)
...
nnm.solve_NNM_store_and_show(elasticity, u, PHYSREG_VOLUME, par_relaxation, E_fic_formulation, HARMONIC_MEASURED, PHYSREG_MEASURE_POINT, 
